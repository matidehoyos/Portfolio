    ...
    return(
        <div className={style.container}>
                ...
                <div className={style.txtPre}>
                        ...
                        <a href="https://drive.google.com/file/d/1sYzgf98QuJlBUoD-sYAcf2UbSA2C5A3i/view?usp=sharing" target="_blank" rel="noopener noreferrer"><button className={style.cv}>Download CV <FaFile className={style.file}/></button></a>
                        </div>
