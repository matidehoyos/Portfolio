...
const Header = () => {
    ...
    return (
        <div className={style.container} id='header' style={{background: theme === 'light' ? "#eee" : ''}}>
            ...
            <div className={style.imgPre} style={{backgroundImage: theme === 'light' ? 'url(./bgHeader1.png)' : '',backgroundPosition: 'top center', backgroundSize: 'cover', width: '100vw'}} data-aos="fade-up" data-aos-duration="800">
                <img src="nav.png" alt="foto mia" className={style.imgHeader} style={{filter: theme === 'light' ? 'drop-shadow(0px 0px 18px #000) grayscale(85%)' : 'drop-shadow(0px 0px 18px #000) grayscale(85%)', opacity: theme === 'light' ? '1' : '1'}} />
            </div>
