                ...
                <div className={style.first}>
                    ...
                    <div className={style.txt}>
                        ...
                        <div className={style.butons}>
                            <a href="https://medibooks.vercel.app"  target="_blank" rel="noopener noreferrer" className={`${style.butonWeb} ${isLightMobile ? style.butonWebLight : style.butonWeb}`} style={{background: theme === 'light' ? '#ff8e00' : '', color: theme === 'light' ? '#111' : '', border: theme === 'light' ? '1px solid #111' : ''}}>
