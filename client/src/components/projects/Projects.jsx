            ...
            <div className={style.projectContainer}>
                {projects.map((project, index) => (
                    <div className={style.boxPc} key={index} data-aos="fade-up" data-aos-duration="800" style={{background: theme === 'light' ? '#00000005' : ''}}>
                            ...
                            <p className={style.titu} style={{color: theme === 'light' ? '#000' : '#fff', fontWeight: theme === 'light' ? '600' : '500'}}>{project.titulo[i18n.language]}</p>
                            <p className={style.detalle} style={{color: theme === 'light' ? '#444' : '#aaa', fontWeight: theme === 'light' ? '500' : '300'}}>{project.detail[i18n.language]}</p>
